...
class ServiceProvider(db.Model):
    ...
    service_advisor_no = db.Column(db.String(255))
    workshop_no = db.Column(db.String(255))
    latitude = db.Column(db.String(255))
    longitude = db.Column(db.String(255))
    user_pic = db.Column(db.String(255))
    workshop_pic = db.Column(db.String(255))
    ...
    general_service = db.Column(db.String(255))
    roadside_assistance = db.Column(db.String(255))
    maintenence_repair = db.Column(db.String(255))
    dent_repairing = db.Column(db.String(255))
    car_wash = db.Column(db.String(255))
